...
export const defaultToolboxOptions: ToolboxOptions = { trim: false, resize: "original", width: 2000, height: 2000, percent: 100, rotation: 0, flip_horizontal: false, flip_vertical: false, padding: 0, background: "transparent", color: "#ffffff", background_asset_id: null, format: "png", compression: "quality", quality: 85, target_kb: 500 };
...
export const processingSteps = (o: ToolboxOptions) => [o.trim && "去透明边", o.resize !== "original" && "调整尺寸", (o.rotation || o.flip_horizontal || o.flip_vertical) && "旋转翻转", o.padding > 0 && "增加留白", o.background !== "transparent" && "合成背景", `${o.format.toUpperCase()}${o.compression === "target" ? ` ≤ ${o.target_kb} KB` : o.format === "png" ? " 无损压缩" : ` · 质量 ${o.quality}`}`].filter(Boolean).join(" → ");
